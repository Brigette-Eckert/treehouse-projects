...
# coverage report command will print out coverage % per file
# coverage report -m command will tell you what lines are missing tests
# coverage html command will generate hmtlcov folder
